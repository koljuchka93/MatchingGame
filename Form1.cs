    ...
    public partial class Form1 : Form
    {
        ...
        private void Label_Click(object sender, EventArgs e)
        {
            ...
            if (clickedLabel != null)
            {
                ...
                // and reset firstClicked and secondClicked so the player can click another icon
        ...
        // --- Add TimerEvent in Property -> Events ---
        private void TimerEvent(object sender, EventArgs e)
        {
            ...
            // so the next time a label is clicked, the program knows it's the first click
            firstClicked = null;
            secondClicked = null;
        }
